  ...
  return (
    <div className="onvo-w-full onvo-flex onvo-flex-row onvo-gap-2 onvo-my-2 onvo-overflow-x-auto onvo-scrollbar-thin onvo-max-w-screen-lg onvo-mx-auto">
      {suggestions.map((a) => (
        <div
          key={a.name}
          className="onvo-background-color onvo-flex onvo-flex-shrink-0 onvo-flex-row onvo-items-center onvo-gap-1 onvo-bg-blue-50 dark:onvo-bg-blue-950 onvo-border-solid onvo-border onvo-border-blue-500 onvo-rounded-full onvo-py-1 onvo-px-2 hover:onvo-bg-blue-100 dark:hover:onvo-bg-blue-900 onvo-cursor-pointer"
