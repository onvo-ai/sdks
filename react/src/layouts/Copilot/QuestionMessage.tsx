  ...
  logo,
    ...
    if (role === "user") {
      ...
      return (
        <div className="onvo-question-message-user onvo-group onvo-relative onvo-mb-3 onvo-flex onvo-flex-row onvo-items-start onvo-justify-start onvo-gap-3">
          <Icon variant="shadow" className="onvo-border-black/10 dark:onvo-border-white/10 onvo-background-color" icon={UserIcon} />
    ...
    const LogoIcon = useMemo(() => {
      return logo && logo.trim() !== "" ? (
        <Icon
          variant="shadow"
          className="!onvo-p-0 onvo-border-black/10 dark:onvo-border-white/10 onvo-background-color"
          icon={() => (
            <img
              src={logo}
        ...
        <Icon variant="shadow" className="onvo-border-black/10 dark:onvo-border-white/10 onvo-background-color" icon={() => <Logo height={20} width={20} />} />
      );
    }, [logo]);
