...
To activate the Onvo-MySQL Integration, simply login to your Onvo account, go to Data sources click on “New data source”. You can now choose the option for SQL DB and click on "Connect". You will then be redirected to a configuration page where you can enter the SQL credentials and the query needed to get the view you want.
