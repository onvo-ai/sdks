...
In your backend environment, install the `@onvo-ai/node` package, this lets you authenticate users, setup sessions and fetch the list of dashboards.
...
<CardGroup cols={2}>
  ...
  <Card title="NPM" icon="npm">
    https://www.npmjs.com/package/@onvo-ai/node
  </Card>
</CardGroup>
