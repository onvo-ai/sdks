...
describe("Teams", () => {
    let onvoTeams;
    beforeEach(() => {
        onvoTeams = new OnvoTeams("eyJhbGciOiJIUzI1NiJ9.eyJyb2xlIjoiYXV0aGVudGljYXRlZCIsImFwcF9tZXRhZGF0YSI6eyJ0ZWFtIjoiM2QwNWI5OTAtYzg1NS00OTQ1LWJkZDEtYjNhODMwNWZmYzU5In0sInN1YiI6IjNkMDViOTkwLWM4NTUtNDk0NS1iZGQxLWIzYTgzMDVmZmM1OSIsImF1ZCI6ImF1dGhlbnRpY2F0ZWQiLCJpYXQiOjE3MDc0ODU5MTZ9.VxHmDH_CgaJTbIFL1ysxc_PFXN6cMgS1ampyJLs4A7k", {
    ...
    it("should update a team", async () => {
        const account = await onvoTeams.update("3d05b990-c855-4945-bdd1-b3a8305ffc59", {
            name: "In test",
        });
